all: 
	...
	@wget -O Domains_of_5,000_GitHub_Repositories_-_Public_-_Domains.csv https://zenodo.org/record/804474/files/Domains%20of%205%2C000%20GitHub%20Repositories%20-%20Public%20-%20Domains.csv?download=1
...
clone:
	@python3 clone-repositories.py

scancode:
	@python3 license-scan.py

duplicate:
	@python3 duplicate-license.py